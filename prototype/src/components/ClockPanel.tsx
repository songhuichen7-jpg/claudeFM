 ...
 * dot-grid, a big pixel-font HH:MM, the weekday/date and an ON AIR status.
 * No gradients, no glow — purely typographic.
 */
export function ClockPanel({ onTap }: Props) {
    ...
    >
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="mt-3 flex items-center gap-1.5">
          ...
          />
          <span
            className="font-mono text-[10px] tracking-[0.34em]"
